...
# 6. to do this quickly, assign key press as a dict whose value is mulipler and key is the char.
# 7. then O(1) on the dict, and add so O(1) + O(n) and the calc time is O(n)
